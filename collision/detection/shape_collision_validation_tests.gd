...
func test_shape_positioning_validation(
	...
	test_parameters := [
		["Capsule at Origin", TestShapeType.CAPSULE, {"radius": 14.0, "height": 60.0}, Vector2(0,0), Vector2(0,0)],
		["Capsule at Position", TestShapeType.CAPSULE, {"radius": 14.0, "height": 60.0}, Vector2(400,300), Vector2(400,300)],
		["Trapezoid at Position", TestShapeType.TRAPEZOID, {
			"points": PackedVector2Array([
				Vector2(-32, 12), Vector2(-16, -12), Vector2(17, -12), Vector2(32, 12)
			])
