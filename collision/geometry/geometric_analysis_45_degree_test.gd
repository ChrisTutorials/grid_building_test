...
##
## Investigation into 45° skew and rotation transforms on 32x32 squares shows that both
## transforms create diamond-shaped results that naturally intersect 3 tiles, not 4.
##
## Key findings:
## 1. 45° skew of 32x32 square creates diamond spanning 1×2 tiles
## 2. 45° rotation of 32x32 square creates diamond with vertices at ±22.63
## 3. Both transforms create pointed diamonds, not rectangular coverage
...
## Alternative: Use larger base polygons (e.g., 40x40) if 4-tile coverage is needed.
