...
func before_test() -> void:
	...
	collision_mapper = test_hierarchy.collision_mapper
	indicator_manager = test_hierarchy.indicator_manager
	tile_map = test_hierarchy.tile_map
...
func test_positioner_with_collision_tracking() -> void:
	...
	var test_setup: IndicatorCollisionTestSetup = UnifiedTestFactory.create_test_indicator_collision_setup(self, collision_body)
