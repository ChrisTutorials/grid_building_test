...
# TestSuite for IndicatorCollisionTestSetup class functionality
...
func test_adjust_rect_to_testing_size(p_setups : Array[IndicatorCollisionTestSetup], _test_parameters := [
	[create_test_setups(eclipse_obj)],
	[create_test_setups(rect_8_tiles_obj)],
	[create_test_setups(test_skew_rotation_rect_obj)],
	[create_test_setups(pillar_obj)]
