...
static func create_minimal_test_environment(
...
static func create_indicator_manager_with_validation(
	...
	var manager: IndicatorManager = IndicatorManager.create_with_injection(
		env.injector.composition_container
	)
	...
	var issues: Array[String] = (
		env.injector.composition_container.get_targeting_state().get_runtime_issues()
	)
...
static func _setup_targeting_state_for_tests(
	test_suite: GdUnitTestSuite, env: AllSystemsTestEnvironment
) -> void:
	var targeting_state: GridTargetingState = (
		env.injector.composition_container.get_targeting_state()
	)
...
static func validate_building_system_entry(
	...
	result.preview = (
		env.injector.composition_container.get_building_state().preview
