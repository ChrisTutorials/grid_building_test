...
func test_exclusion_works_when_positioner_inside_original_bounds() -> void:
 ...
 assert_bool(indicator.valid)
  .append_failure_message("Indicator should be valid when collision body is excluded").is_true()
...
func test_exclusion_fails_when_positioner_outside_original_bounds() -> void:
 ...
 assert_bool(indicator.valid)
 	.append_failure_message("Indicator should be valid when positioned outside original bounds with exclusion")
 	.is_true()
...
func test_exclusion_works_at_edge_of_original_bounds() -> void:
 ...
 assert_bool(indicator.valid)
 	.append_failure_message("Indicator at edge of original bounds should be valid when body is excluded")
 	.is_true()
...
func test_multiple_indicators_outside_bounds_all_excluded() -> void:
 ...
 assert_bool(indicator_right.valid)
  .append_failure_message("Right indicator should be valid when body is excluded").is_true()
 assert_bool(indicator_left.valid)
  .append_failure_message("Left indicator should be valid when body is excluded").is_true()
 assert_bool(indicator_top.valid)
  .append_failure_message("Top indicator should be valid when body is excluded").is_true()
 assert_bool(indicator_bottom.valid)
  .append_failure_message("Bottom indicator should be valid when body is excluded").is_true()
...
func test_exclusion_independent_of_positioner_movement() -> void:
 ...
 assert_bool(valid_inside)
  .append_failure_message("Indicator should be valid inside bounds when body is excluded").is_true()
 assert_bool(valid_outside)
 	.append_failure_message("Indicator should remain valid outside bounds when body is excluded")
 	.is_true()
