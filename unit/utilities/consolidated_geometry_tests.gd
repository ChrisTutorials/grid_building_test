...
func test_correct_trapezoid_geometry() -> void:
	...
	var trapezoid_points: PackedVector2Array = PackedVector2Array([Vector2(-16, 8), Vector2(-8, -8), Vector2(8, -8), Vector2(16, 8)])
...
func test_indicator_polygon_heuristics() -> void:
	...
	for polygon_data: Dictionary in test_polygons:
		...
		var tiles = CollisionGeometryCalculator.calculate_tile_overlap(
			points, Vector2(16,16), TileSet.TILE_SHAPE_SQUARE, 0.01, 0.01
		)
...
# ================================
# COMPREHENSIVE GEOMETRY MATH TESTS (from gb_geometry_math_test.gd)
# ================================
