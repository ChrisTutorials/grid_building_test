...
func test_trapezoid_world_transform_and_tile_offsets() -> void:
	...
	positioner.global_position = Vector2global_position

	var polygon := CollisionPolygon2D.new()
	polygon.polygon = PackedVector2Array[Node2D]([
	...
	world_points = PackedVector2Array[Node2D](world_points)
...
func test_compute_polygon_tile_offsets(test_name: String, polygon_points: PackedVector2Array[Node2D], world_position: Vector2, tile_size: Vector2, expected_min_offsets: int, description: String, test_parameters := [
		# Basic geometric shapes
		["single_tile_square", PackedVector2Array[Node2D]([Vector2(-8,-8), Vector2(8,-8), Vector2(8,8), Vector2(-8,8)]), Vector2(20,20), Vector2(16,16), 1, "16x16 square at center of tile should cover 1 tile"],
		["two_tile_rectangle", PackedVector2Array[Node2D]([Vector2(-24,-8), Vector2(24,-8), Vector2(24,8), Vector2(-24,8)]), Vector2(32,32), Vector2(16,16), 2, "48x16 rectangle should cover 2+ tiles horizontally"],
		["four_tile_large_square", PackedVector2Array[Node2D]([Vector2(-16,-16), Vector2(16,-16), Vector2(16,16), Vector2(-16,16)]), Vector2(32,32), Vector2(16,16), 4, "32x32 square should cover 4 tiles"],
		
		# Edge cases and boundary conditions
		["tiny_polygon", PackedVector2Array[Node2D]([Vector2(-1,-1), Vector2(1,-1), Vector2(1,1), Vector2(-1,1)]), Vector2(16,16), Vector2(16,16), 1, "Tiny 2x2 polygon should still register overlap"],
		["tile_boundary_polygon", PackedVector2Array[Node2D]([Vector2(-8,-8), Vector2(8,-8), Vector2(8,8), Vector2(-8,8)]), Vector2(16,16), Vector2(16,16), 1, "Polygon exactly on tile boundary should overlap"],
		["cross_tile_boundary", PackedVector2Array[Node2D]([Vector2(-8,-8), Vector2(8,-8), Vector2(8,8), Vector2(-8,8)]), Vector2(24,24), Vector2(16,16), 4, "Polygon crossing tile boundaries should overlap multiple tiles"],
		
		# Triangle shapes
		["triangle_single_tile", PackedVector2Array[Node2D]([Vector2(0,-10), Vector2(-8,8), Vector2(8,8)]), Vector2(20,20), Vector2(16,16), 1, "Triangle within single tile"],
		["triangle_multi_tile", PackedVector2Array[Node2D]([Vector2(0,-20), Vector2(-16,16), Vector2(16,16)]), Vector2(32,32), Vector2(16,16), 2, "Triangle spanning multiple tiles"],
		
		# Diamond/rhombus shapes
		["diamond_shape", PackedVector2Array[Node2D]([Vector2(0,-12), Vector2(12,0), Vector2(0,12), Vector2(-12,0)]), Vector2(32,32), Vector2(16,16), 1, "Diamond shape centered in tile"],
		
		# Different tile sizes
		["large_tile_small_polygon", PackedVector2Array[Node2D]([Vector2(-4,-4), Vector2(4,-4), Vector2(4,4), Vector2(-4,4)]), Vector2(40,40), Vector2(40,40), 1, "Small polygon in large tile"],
		["small_tile_large_polygon", PackedVector2Array[Node2D]([Vector2(-16,-16), Vector2(16,-16), Vector2(16,16), Vector2(-16,16)]), Vector2(10,10), Vector2(8,8), 9, "Large polygon covering many small tiles"],
		
		# Irregular polygons
		["l_shape", PackedVector2Array[Node2D]([Vector2(-12,-12), Vector2(4,-12), Vector2(4,-4), Vector2(12,-4), Vector2(12,12), Vector2(-12,12)]), Vector2(32,32), Vector2(16,16), 3, "L-shaped polygon"],
		
		# Coordinates matching polygon_tile_mapper test cases
		["mapper_test_coords", PackedVector2Array[Node2D]([Vector2(-20,-20), Vector2(20,-20), Vector2(20,20), Vector2(-20,20)]), Vector2(320,320), Vector2(40,40), 1, "Coordinates from failing mapper tests"]
	]) -> void:
...
func test_compute_polygon_tile_offsets_edge_cases() -> void:
	...
	var empty_result := CollisionGeometryUtils.compute_polygon_tile_offsets(PackedVector2Array[Node2D](), tile_size, center_tile)
	...
	var point_result := CollisionGeometryUtils.compute_polygon_tile_offsets(PackedVector2Array[Node2D]([Vector2(32, 32)]), tile_size, center_tile)
	...
	var line_result := CollisionGeometryUtils.compute_polygon_tile_offsets(PackedVector2Array[Node2D]([Vector2(32, 32), Vector2(48, 32)]), tile_size, center_tile)
...
func test_is_polygon_convex() -> void:
	# Convex shapes
	assert_bool(CollisionGeometryUtils.is_polygon_convex(PackedVector2Array[Node2D]([Vector2(0,0), Vector2(10,0), Vector2(10,10), Vector2(0,10)]))).override_failure_message("Square should be convex")
	assert_bool(CollisionGeometryUtils.is_polygon_convex(PackedVector2Array[Node2D]([Vector2(0,0), Vector2(5,0), Vector2(2.5,5)]))).override_failure_message("Triangle should be convex")
	
	# Non-convex shape (L-shape)
	var l_shape := PackedVector2Array[Node2D]([Vector2(0,0), Vector2(10,0), Vector2(10,5), Vector2(5,5), Vector2(5,10), Vector2(0,10)])
