...
func assert_contains_position(positions: Array[Vector2i], target_pos: Vector2i, message: String) -> void:
...
func test_collision_utilities_indicator_overlap() -> void:
	...
	var result: bool = CollisionUtilities.does_indicator_overlap_shape(indicator, target_shape, shape_owner)
