...
func test_get_tile_polygon_for_all_shapes(
	...
	var tile_polygon = GBGeometryMath.get_tile_polygon(tile_pos, tile_size, tile_shape)
...
# ================================
# POLYGON OVERLAP DETECTION TESTS
# ================================
...
# ================================
# SHAPE TO POLYGON CONVERSION TESTS
# ================================
...
func test_get_polygon_bounds_edge_cases() -> void:
	...
	# Multiple points
	var multi_point_bounds = GBGeometryMath.get_polygon_bounds(PackedVector2Array([Vector2(0, 0), Vector2(10, 0), Vector2(10, 10), Vector2(0, 10)]))
...
func test_polygon_intersection_area_edge_cases() -> void:
	# Empty polygons
	var area1 = GBGeometryMath.polygon_intersection_area(PackedVector2Array(), PackedVector2Array([Vector2(0, 0), Vector2(10, 0), Vector2(10, 10), Vector2(0, 10)]))
	...
	var poly1 = PackedVector2Array([Vector2(0, 0), Vector2(5, 0), Vector2(5, 5), Vector2(0, 5)])
	var poly2 = PackedVector2Array([Vector2(10, 10), Vector2(15, 10), Vector2(15, 15), Vector2(10, 15)])
