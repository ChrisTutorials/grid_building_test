...
func test_intersection_area_with_tile_for_all_shapes(
	...
	test_parameters := [
		...
		[
			"small_square_polygon_square_tile",
		...
		[
			"small_square_polygon_isometric_tile",
			PackedVector2Array([Vector2(4, 4), Vector2(12, 4), Vector2(12, 12), Vector2(4, 12)]),
			Vector2(0, 0),
			Vector2(16, 16),
		...
		[
			"small_square_polygon_half_offset_tile",
			PackedVector2Array([Vector2(4, 4), Vector2(12, 4), Vector2(12, 12), Vector2(4, 12)]),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_HALF_OFFSET_SQUARE,
		...
		[
			"center_square_polygon_square_tile",
		...
		[
			"center_square_polygon_isometric_tile",
			PackedVector2Array([Vector2(6, 6), Vector2(10, 6), Vector2(10, 10), Vector2(6, 10)]),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_ISOMETRIC,
		...
		[
			"center_square_polygon_half_offset_tile",
			PackedVector2Array([Vector2(6, 6), Vector2(10, 6), Vector2(10, 10), Vector2(6, 10)]),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_HALF_OFFSET_SQUARE,
		...
		[
			"large_polygon_square_tile",
			PackedVector2Array(
				[Vector2(-4, -4), Vector2(20, -4), Vector2(20, 20), Vector2(-4, 20)]
			),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_SQUARE,
		...
		[
			"large_polygon_half_offset_tile",
			PackedVector2Array(
				[Vector2(-4, -4), Vector2(20, -4), Vector2(20, 20), Vector2(-4, 20)]
			),
			Vector2(0, 0),
...
func test_does_polygon_overlap_tile_for_all_shapes(
	...
	test_parameters := [
		# Overlapping cases
		[
			"overlapping_square_square_tile",
			PackedVector2Array([Vector2(4, 4), Vector2(12, 4), Vector2(12, 12), Vector2(4, 12)]),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_SQUARE,
		...
		[
			"overlapping_square_isometric_tile",
			PackedVector2Array([Vector2(4, 4), Vector2(12, 4), Vector2(12, 12), Vector2(4, 12)]),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_ISOMETRIC,
		...
		[
			"overlapping_square_half_offset_tile",
			PackedVector2Array([Vector2(4, 4), Vector2(12, 4), Vector2(12, 12), Vector2(4, 12)]),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_HALF_OFFSET_SQUARE,
		...
		[
			"non_overlapping_isometric_tile",
			PackedVector2Array(
				[Vector2(20, 20), Vector2(24, 20), Vector2(24, 24), Vector2(20, 24)]
			),
			Vector2(0, 0),
		...
		[
			"non_overlapping_half_offset_tile",
			PackedVector2Array(
				[Vector2(20, 20), Vector2(24, 20), Vector2(24, 24), Vector2(20, 24)]
			),
			Vector2(0, 0),
		...
		[
			"small_overlap_below_epsilon_square",
			PackedVector2Array(
				[Vector2(15, 15), Vector2(17, 15), Vector2(17, 17), Vector2(15, 17)]
			),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_SQUARE,
		...
		[
			"small_overlap_above_epsilon_square",
			PackedVector2Array(
				[Vector2(12, 12), Vector2(20, 12), Vector2(20, 20), Vector2(12, 20)]
			),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_SQUARE,
		...
		[
			"diamond_polygon_isometric_tile",
		...
		[
			"triangle_large_square_tile",
			PackedVector2Array([Vector2(0, 0), Vector2(32, 0), Vector2(16, 32)]),
			Vector2(0, 0),
			Vector2(32, 32),
			TileSet.TILE_SHAPE_SQUARE,
			1.0,
		...
		[
			"concave_indented_large",
			PackedVector2Array(
				[Vector2(0, 0), Vector2(32, 0), Vector2(16, 16), Vector2(32, 32), Vector2(0, 32)]
			),
			Vector2(0, 0),
			Vector2(32, 32),
			TileSet.TILE_SHAPE_SQUARE,
	...
	var overlaps: bool = GBGeometryMath.does_polygon_overlap_tile(
		polygon, tile_pos, tile_size, tile_shape, epsilon
	)
...
func test_does_shape_overlap_tile_optimized_for_all_shapes(
	...
	test_parameters := [
		# Rectangle overlaps
		[
			"rect_overlap_square_tile",
			"rectangle",
			Vector2(8, 8),
			Transform2D(0, Vector2(8, 8)),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_SQUARE,
			true
		...
		[
			"rect_no_overlap_square_tile",
			"rectangle",
			Vector2(4, 4),
			Transform2D(0, Vector2(20, 20)),
			Vector2(0, 0),
			Vector2(16, 16),
			TileSet.TILE_SHAPE_SQUARE,
			false
		...
		[
			"rect_no_overlap_isometric_tile",
			"rectangle",
			Vector2(4, 4),
			Transform2D(0, Vector2(20, 20)),
			Vector2(0, 0),
		...
		[
			"rect_no_overlap_half_offset_tile",
			"rectangle",
			Vector2(4, 4),
			Transform2D(0, Vector2(20, 20)),
			Vector2(0, 0),
		...
		[
			"circle_overlap_half_offset_tile",
			"circle",
			Vector2(6, 6),
			Transform2D(0, Vector2(8, 8)),
			Vector2(0, 0),
		...
		[
			"circle_no_overlap_isometric_tile",
			"circle",
			Vector2(2, 2),
			Transform2D(0, Vector2(20, 20)),
			Vector2(0, 0),
		...
		[
			"circle_no_overlap_half_offset_tile",
			"circle",
			Vector2(2, 2),
			Transform2D(0, Vector2(20, 20)),
			Vector2(0, 0),
	...
	var overlaps: bool = GBGeometryMath.does_shape_overlap_tile_optimized(
		shape, shape_transform, tile_pos, tile_size, tile_shape, 0.01
	)
...
func test_get_polygon_bounds_edge_cases() -> void:
	...
	# Single point
	var single_point_bounds: Rect2 = GBGeometryMath.get_polygon_bounds(
	...
	# Multiple points
	var multi_point_bounds: Rect2 = GBGeometryMath.get_polygon_bounds(
...
func test_polygon_intersection_area_edge_cases() -> void:
	# Empty polygons
	var area1: float = GBGeometryMath.polygon_intersection_area(
		PackedVector2Array(),
		PackedVector2Array([Vector2(0, 0), Vector2(10, 0), Vector2(10, 10), Vector2(0, 10)])
	)
	(
	...
	var poly1: PackedVector2Array = PackedVector2Array(
		[Vector2(0, 0), Vector2(5, 0), Vector2(5, 5), Vector2(0, 5)]
	)
	var poly2: PackedVector2Array = PackedVector2Array(
		[Vector2(10, 10), Vector2(15, 10), Vector2(15, 15), Vector2(10, 15)]
	)
