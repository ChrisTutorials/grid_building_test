...
func test_create_empty_tile_map_layer():
...
func test_create_manipulatable():
	var manipulatable: Manipulatable = GodotTestFactory.create_manipulatable(self, "TestManipulatable")
...
func test_create_static_body_with_rect_shape_default():
...
func test_create_static_body_with_rect_shape_custom():
	var body: StaticBody2D = GodotTestFactory.create_static_body_with_rect_shape(self, Vector2(10, 20))
...
func test_create_area2d_with_circle_shape():
...
func test_create_collision_polygon_default():
...
func test_create_collision_polygon_custom():
	var custom_points = PackedVector2Array([Vector2(0, 0), Vector2(10, 0), Vector2(10, 10), Vector2(0, 10)])
...
func test_create_object_with_circle_shape():
	...
	var body = obj.get_child(0) as StaticBody2D
	assert_object(body).is_not_null()
...
func test_create_parent_with_body_and_polygon():
	...
	var has_body = child1 is StaticBody2D or child2 is StaticBody2D
	var has_polygon = child1 is CollisionPolygon2D or child2 is CollisionPolygon2D
	
	assert_bool(has_body).is_true()
	assert_bool(has_polygon).is_true()

func test_create_rectangle_shape():
